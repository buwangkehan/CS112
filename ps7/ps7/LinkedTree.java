...
public class LinkedTree {
    ...
    /* Returns a poster iterator for this tree. */
    ...
    /* a skeleton for my iterator class*/
        ...
        public int next() {
            ...
            if (nextNode.parent == null) {
                ...
                if (nextNode == nextNode.parent.right) {
                    ...
                    Node trav = nextNode.parent.right;
                    while (true) {
                        if (trav.left != null) {
                            trav = trav.left;
                        } else if (trav.right != null){
    ...
    /*
     * takes an integer key as its only parameter 
     * and that uses uses iteration to determine 
     * and return the depth of the node with that key.
     */
    ...
    /* takes a reference to a Node object as its only parameter; 
     * it should use recursion to find and return the number of even keys 
    ...
    private static int numEvenKeysRec(Node root) {
        ...
        if (root.key % 2 == 0) {
            return 1 + numEvenKeysRec(root.left) + numEvenKeysRec(root.right);
        }
        return numEvenKeysRec(root.left) + numEvenKeysRec(root.right);
    }
    /*takes no parameters and that returns the number of even keys in the entire tree. */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--- Testing depthInTree() from Problem 6 ---");
        System.out.println();
        try {
            LinkedTree tree = new LinkedTree();

            System.out.println("(0) Testing on tree from Problem 6, depth of 48 node");            
            int results = tree.depthIter(48);
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
            ...
            System.out.println("(1) Testing on tree from Problem 6, depth of 48 node");   
            results = tree.depthIter(48);
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
            ...
            System.out.println("(2) Testing on tree from Problem 6, depth of 28 node");   
            results = tree.depthIter(28);
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
            System.out.println(3);
            ...
            System.out.println("(3) Testing on tree from Problem 6, depth of 44 node");   
            results = tree.depthIter(44);
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
            ...
            System.out.println("(4) Testing on tree from Problem 6, depth of 30 node");   
            results = tree.depthIter(30);
            System.out.println("actual results:");
            System.out.println(results);
            System.out.println("expected results:");
            System.out.println(-1);
        ...
        System.out.println("--- Testing postIterator() from Problem 7 ---");
        System.out.println();
        try {
            LinkedTree tree = new LinkedTree();
            int[] keys = {44, 35, 53, 23, 48, 62, 28, 57, 80};
            tree.insertKeys(keys);
            tree.levelOrderPrint();
            System.out.println("(0) Testing on preorderIterator from Problem 7");
            ...
            System.out.println();
            System.out.println("(1) Testing on postorderIterator from Problem 7");
