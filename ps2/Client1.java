...
public class Client1 {
    ...
    public static void main(String[] args) {  
        System.out.print("isValidColor test 1 (blue, should be true) = ");
        boolean test1 = Card.isValidColor("blue");
        System.out.println(test1);

        System.out.print("isValidColor test 2 (Blue, should be false) = ");
        boolean test2 = Card.isValidColor("Blue");
        System.out.println(test2);

        System.out.print("isValidColor test 3 (yellow, should be true) = ");
        boolean test3 = Card.isValidColor("yellow");
        System.out.println(test3);

        System.out.print("isValidColor test 4 (purple, should be false) = ");
