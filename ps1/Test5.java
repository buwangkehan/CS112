/*
 * Test program for PS 1, Problem 5.
 *
 * Put this program in the same folder as your Methods5.java.
 *
...
public class Test5 {
    public static void main(String[] args) {
        ...
        char mid1 = Methods5.middleChar("clock");
        System.out.println(mid1);
        System.out.println();      
                
        System.out.println("** part 2, example 2 **");
        char mid2 = Methods5.middleChar("Boston");
        System.out.println(mid2);
        System.out.println();
        
        System.out.println("** part 3, example 1 **");
        String str1 = Methods5.moveToEnd("Boston", 4);
        System.out.println(str1);
        System.out.println();
        
        System.out.println("** part 3, example 2 **");
        String str2 = Methods5.moveToEnd("Terriers", 2);
        System.out.println(str2);
        System.out.println();

        System.out.println("** part 3, example 3 **");
        String str3 = Methods5.moveToEnd("Boston", 8);
